package com.slimvan.xingyun.view.skin;

import android.content.Context;
import android.content.SharedPreferences;

import com.slimvan.xingyun.application.App;
...
public class SkinHelper {
    ...
    static String DEF_SHARE_NAME= Constants.SHARE_NAME;
    ...
    private static SharedPreferences getSharePrefer(String shareName) {
        return App.getContext().getSharedPreferences(shareName, MODE);
    }
