package com.xingyun.slimvan.view.loadingtips;
...
public class QMUITipDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public QMUITipDialog create() {
            ...
            View view = LayoutInflater.from(mContext).inflate(R.layout.qmui_tip_dialog_layout,null);
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(ConvertUtils.dp2px(32));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = ConvertUtils.dp2px( 12);
                }
