...
import static com.xingyun.slimvan.util.Utils.getContext;
...
public class SkinHelper {
    ...
    public static String DEF_SHARE_NAME= "xingyun";
    ...
    private static SharedPreferences getSharePrefer(String shareName) {
        return getContext().getSharedPreferences(shareName, MODE);
    }
